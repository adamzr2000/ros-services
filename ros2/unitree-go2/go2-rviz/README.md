...
This module provides [RViz2](https://docs.ros.org/en/humble/p/rviz2/), a 3D visualization tool for ROS 2, used to display data in real time of the Unitree Go2 robot (e.g., state, TF frames, sensor outputs, and maps).
